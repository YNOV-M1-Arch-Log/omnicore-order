...
COPY --from=builder --chown=nodejs:nodejs /app/omnicore-order/node_modules ./omnicore-order/node_modules
...
# Service source code
COPY --chown=nodejs:nodejs omnicore-order/ ./omnicore-order/

USER nodejs

WORKDIR /app/omnicore-order
